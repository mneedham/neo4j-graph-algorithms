...
Resource Allocation similarity was introduced in 2009 by Tao Zhou, Linyuan Lü, and Yi-Cheng Zhang as part of a study to predict links in various networks.
...
[[algorithms-linkprediction-resource-allocation-usecase]]
== Use-cases - when to use the Resource Allocation algorithm
