...
* <<algorithms-similarity-jaccard-procedure-sample, Jaccard Similarity algorithm procedure sample>>
...
== Jaccard Similarity algorithm procedure sample

The Jaccard Similarity procedure computes similarity between all pairs of items.
...
.The following will find the most similar (`topK=1`) person to Arya and Praveena:
[source, cypher]
----
