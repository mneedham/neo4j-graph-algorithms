...
// tag::introduction[]
link:https://arxiv.org/pdf/0901.0553.pdf[Preferential Attachment] is a measure used to compute the closeness of nodes based on their shared neighbors.
// end::introduction[]
...
.The following will return the Preferential Attachment score for Michael and Karin based only on the `FRIENDS` relationships:
[source, cypher]
----
